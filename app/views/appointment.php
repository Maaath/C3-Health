      ...
      <div class="row justify-content-center">
        <div class="col-lg-10 mt-5">
          ...
          <div class="owl-carousel wow fadeInUp" id="nextCarrousel">
            ...
            <?php
            if (count($_SESSION['next_appointments'])) {
              foreach ($_SESSION['next_appointments'] as $value) {
            ?>
                <div class="item">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-10 mt-5">
          ...
          <div class="owl-carousel wow fadeInUp" id="requestCarrousel">
            ...
            <?php
            if (count($_SESSION['wait_appointments'])) {
              foreach ($_SESSION['wait_appointments'] as $value) {
            ?>
