...
<head>
  ...
  <title>C3 Health - Exams History</title>
      ...
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Histórico de exames</li>
          </ol>
        </nav>
        <h1 class="font-weight-normal">Histórico de exames</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10 mt-5">
          <h1 class="text-center mb-5 wow fadeInUp" style="color: #00D9A5 ;">Exames </h1>
