...
<head>
    ...
    <title>C3 Health - Appointment</title>
...
<body>
            ...
            <div class="container">
                ...
                <!-- <form action="#">
                    <div class="input-group input-navbar">
                        ...
                        <input type="text" class="form-control" placeholder="Pesquise aqui" aria-label="Username"
    ...
    <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
        <div class="banner-section">
            <div class="container text-center wow fadeInUp">
                ...
                <h1 class="font-weight-normal">Consultas</h1>
            </div> <!-- .container -->
        </div> <!-- .banner-section -->
    </div> <!-- .page-banner -->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10 mt-5">
          <h1 class="text-center mb-5 wow fadeInUp" style="color: #00D9A5 ;">Próximas Consultas</h1>
            ...
            <div class="item">
              <div class="card-doctor">
                <div class="header">
                  ...
                  <div class="meta">
                    <abbr title="Ver histórico de consultas do paciente"><a href="appointment-history.php"><span
                          class="mai-search"></span></a></abbr>
                    <abbr title="Desmarcar Consulta"><a href="#"><span class="mai-remove"></span></a></abbr>
                  </div>
                </div>
                <div class="body">
  ...
  <div class="page-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10 mt-5">
          <h1 class="text-center mb-5 wow fadeInUp">Meus Pacientes</h1>
          <div class="owl-carousel wow fadeInUp" id="myCarrousel">
            ...
            <div class="item">
              <div class="card-doctor">
                ...
                <div class="body">
                  <p class="text-xl mb-1">Lucas Rodrigues</p>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="card-doctor">
                ...
                <div class="body">
                  <p class="text-xl mb-1">João Paulo</p>
                </div>
              </div>
            </div>
  ...
  <div class="page-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10 mt-5">
          <h1 class="text-center mb-5 wow fadeInUp">Solicitações de Consultas</h1>
            ...
            <div class="item">
              <div class="card-doctor">
                <div class="header">
                  <img src="../assets/img/place_holder.png" alt="">
                  <div class="meta">
                    <abbr title="Confirmar consulta"><a href="#"><span class="mai-add"></span></a></abbr>
                    <abbr title="Não aceitar consulta"><a href="#"><span class="mai-remove"></span></a></abbr>
                    <abbr title="Ver histórico de consultas do paciente"><a href="appointment-history.php"><span
                          class="mai-search"></span></a></abbr>
                  </div>
                </div>
