            ...
            <div class="item">
              <div class="card-doctor">
                ...
                <div class="body">
                  ...
                  <p class="text mb-1" style="color: red;">Dr. Stein Albert</p>
                  <span class="text-sm text-grey">15/10/21 as 17:20 h</span>
                </div>
                <div class="body">
                    <span class="text-sm text-grey">Tomar Paracetamol</span>
                </div>
                <div class="body">
                    <span class="text-sm text-grey">O paciente estava com nauseas e dor de cabeça</span>
                </div>
              </div>
            </div>
