...
<head>
  ...
  <meta name="copyright" content="Name, https://link.com/">

  <title>C3 Health - Contact</title>
...
<body>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">Contato</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Nos envie a sua dúvida</h1>
      ...
      <form class="contact-form mt-5">
        <div class="row mb-3">
          ...
          <div class="col-12 py-2 wow fadeInUp">
            ...
            <textarea id="message" class="form-control" rows="8" placeholder="Digite a sua mensagem"></textarea>
          </div>
        </div>
