...
<head>
  ...
  <title>C3 Health - Make an exam</title>
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="indphp">Home</a>
            </li>
            <li class="nav-item">
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Marque o seu exame</h1>
      ...
      <form class="main-form">
        ...
        <button type="submit" class="btn btn-primary mt-3 wow zoomIn">Marcar exame</button>
      </form>
    </div>
  </div> <!-- .page-section -->
      ...
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <ul class="footer-menu">
            ...
            <li><a href="login.html">Entre no nosso time</a></li>
          </ul>
        </div>
        <div class="col-sm-6 col-lg-3 py-3">
